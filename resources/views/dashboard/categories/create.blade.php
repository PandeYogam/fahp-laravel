  ...
  <div class="col-lg-8">
    <form action="/dashboard/categories" method="post" class="mb-5" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="name" required autofocus value="{{ old('title') }}">
        @error('title')
      ...
      <div class="mb-3">
        <label for="image" class="form-label">Image Header</label>
      ...
      <div class="mb-3">
        <label for="body" class="form-label">Deskripsi Pendek</label>
        @error('body')
