...
<div class="col-lg-8">
  ...
  {{-- <form action="{{ route('dashboard.categories', $category->slug) }}" method="POST" enctype="multipart/form-data"> --}}
  ...
  {{-- <form action="/dashboard/categories/{{ $category->slug }}" method="post" class="mb-5" enctype="multipart/form-data"> --}}
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="name" required autofocus value="{{ old('name', $category->name) }}">
      @error('title')
    ...
    <div class="mb-3">
      ...
      @enderror
      <input id="body" type="hidden" name="body" value="{{ old('body', $category->body) }}">
