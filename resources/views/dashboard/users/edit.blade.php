    ...
    <div class="mb-3">
        ...
        <div class="d-flex">
            <div class="form-check">
              <input class="form-check-input" type="checkbox" value="pengujung" id="checkboxPengujung" name="checkboxPengujung" {{ $user->is_admin == 0 && $user->is_pengelola_wisata == 0 && $user->is_pengelola_paket_wisata == 0 ? 'checked' : '' }}>
            ...
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value=1 id="checkboxPaketWisata" name="checkboxPengujung" {{ old('role', $user->is_pengelola_paket_wisata) == 1 ? 'checked' : '' }}>
                <label class="form-check-label pe-2" for="checkboxPengujung">
                    Pengelola Paket wisata
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value=1 id="checkboxWisata" name="checkboxPengujung" {{ old('role', $user->is_pengelola_wisata) == 1 ? 'checked' : '' }}>
                <label class="form-check-label pe-2" for="checkboxPengujung">
